...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>Création de votre compte | {{ env('APP_URL') }}</title>
		<style type="text/css">
			/* ----- Custom Font Import ----- */
						...
						<tr>
							<td align="center" valign="top">
								...
								<table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
									...
									<tr>
										<td class="hero-subheader__content" style="font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;" align="left">Bonjour, {{$user->prenom}}.<br/>
											{{--Votre compte a été crée sur la plateforme MMTE. Vous pouvez vous connecter via <a href="http://3.18.176.44" target="_blank">ce lien</a> ou via le bouton suivant:--}}
                                            {{$body}}
										</td>
									</tr>
											...
											<table class="container" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td class="cta-block__button" width="300" align="center" style="width: 300px;">
														<a href="http://3.18.176.44" target="_blank" style="border-radius: 0px; color: #fefefe; background-color: green; text-decoration: none; padding: 15px 45px; text-transform: uppercase; display: block; text-align: center; font-size: 16px;">Acceder à votre compte</a>
													</td>
												</tr>
											</table>
										</td>
													...
													<td class="info-bullets__block" style="padding: 30px 30px 15px 30px;" align="center">
														<table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
															<tr>
																...
																{{--<td class="info-bullets__content" style="color: #969696; font-size: 16px;">contact@mail.com</td>--}}
															</tr>
														</table>
													</td>
													...
													<td class="info-bullets__block" style="padding: 30px;" align="center">
														<table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
															<tr>
																...
																<td class="info-bullets__content" style="color: #969696; font-size: 16px;">Cotonou</td>
															</tr>
														</table>
													</td>
													...
													<td class="info-bullets__block" style="padding: 30px;" align="center">
														<table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
															<tr>
																...
																<td class="info-bullets__content" style="color: #969696; font-size: 16px;">Benin</td>
															</tr>
														</table>
													</td>
												</tr>
									...
									<tr>
										<td align="center">
											<table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="border-top: 1px solid #eeeeee; width: 620px;">
												...
												<tr>
													<td style="color: #d5d5d5; text-align: center; font-size: 15px; padding: 10px 0 60px 0; line-height: 22px;">Copyright &copy; {{ date('Y') }} <a href="" target="_blank" style="text-decoration: none; border-bottom: 1px solid #d5d5d5; color: #d5d5d5;">{{env('APP_NAME')}}</a>. <br />Tous droits réservés.</td>
												</tr>
											</table>
										</td>
									</tr>

	...
	<header id="header">
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="{{ url('/') }}"><img src="img/Logo_chooseme.png" width="auto" height="40" class="d-inline-block align-top" alt="chooseme" title="" /></a>
				</div>
				<nav id="nav-menu-container">
					{{-- <ul class="nav-menu">
						<li><a href="#" class="btn btn-danger">Contact</a></li>
					</ul> --}}
				</nav>
			</div>
		</div>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-between">
                ...
                <div class="home-banner-content col-lg-6 col-md-6">
					<h2>
						Voulez-vous <br> Accélérer votre réussite professionnelle ?
					</h2>
					<p>Rejoins les {{ $totalProspect }} professionnels sur la liste d'attente, afin de faire partir de nos premiers utilisateurs.</p>
			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-12 about-video-right justify-content-center align-items-center d-flex relative">
						...
						<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid mx-auto" src="img/play-btn.png"
							 alt=""></a>
					</div>
				</div>
			</div>

    ...
    <section>
        <div class="row pt-5 content">
            <div class="col-md-4 col-xs-12">
                <img src="img/Entrepreneur.jpg" class="block-image-md" alt="chooseme">
                <h3 class="text-left"><strong>Vous êtes un chef d’entreprise</strong></h3>
                <p>Elargissez votre réseau de contacts, rencontrez des partenaires potentiels, améliorer
                    la marque employeur de votre entreprise tout en ayant une meilleure visibilité sur les
                    meilleurs profils.
                </p>
            </div>
            <div class="col-md-4 col-xs-12">
                <img src="img/En Poste.jpeg" class="block-image-md" alt="chooseme">
                <h3 class="text-left"><strong>Vous êtes un professionnel en poste</strong></h3>
            ...
            <div class="col-md-4 col-xs-12">
                <img src="img/Freelancer.jpeg" class="block-image-md" alt="chooseme">
                <h3 class="text-left"><strong>Vous êtes un freelancer ou travailleur indépendant</strong></h3>
        ...
        <div class="row content pt-5 pb-5 justify-content-center">
            <div class="col-md-4 col-xs-12">
                <img src="img/En recherche d'emploi.jpg" class="block-image-md" alt="chooseme">
            ...
            <div class="col-md-4 col-xs-12">
                <img src="img/Etudiant 2.jpeg" class="block-image-md" alt="chooseme">
